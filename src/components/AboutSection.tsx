        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white">
              Technical Partnership for <span className="text-gradient">Non-Technical Founders</span>
            </h2>
            ...
            <p className="text-lg text-white/70">
              ...
              concepts in terms you'll understand and appreciate.
            </p>
          ...
          <div className="relative">
            ...
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-xl border border-white/20 p-8 shadow-lg hover:shadow-glow transition-shadow duration-500">
              <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                ...
                <span>My Consulting Approach</span>
              </h3>
              
              <div className="space-y-8">
                {[
                  { title: "Understand", description: "I take the time to deeply understand your business, goals, and challenges before proposing any technical solutions." },
                  { title: "Strategize", description: "Working together, we develop a tailored strategy that addresses your specific needs while optimizing for cost, time, and quality." },
                  { title: "Execute", description: "Whether you need hands-on guidance or oversight of your technical teams, I ensure your vision is executed with precision." },
                  { title: "Scale", description: "As your business grows, I help you scale your technical infrastructure and processes to meet increasing demands." }
                ].map((step, index) => (
