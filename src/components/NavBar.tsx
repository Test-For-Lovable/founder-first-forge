            ...
            {navigationLinks.map((link) => (
              <Link 
                ...
                className={`text-white hover:text-futuristic-cyan transition-colors ${
                  location.pathname === link.path ? 'border-b-2 border-futuristic-cyan' : ''
                }`}
              >
                {link.name}
              </Link>
            ))}
            <Button asChild className="bg-gradient-to-r from-futuristic-purple to-futuristic-cyan hover:opacity-90 text-white">
            ...
            <Sheet>
              ...
              <SheetContent className="bg-futuristic-dark text-white border-white/10">
                <nav className="flex flex-col space-y-6 pt-10">
                  ...
                  <Button asChild className="bg-gradient-to-r from-futuristic-purple to-futuristic-cyan hover:opacity-90 text-white w-full">
                    <a href="http://meetings-eu1.hubspot.com/usama-ahmed" target="_blank" rel="noopener noreferrer">
                      Book Call
                    </a>
                  </Button>
